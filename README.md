...
| chart.axisTickAdjusted        | Boolean | ```true``` &#124; ```false```                                         | ```true```                  | If true, the ticks will be positioned according to x value of the data points. If false, the ticks will be positioned nicely.          |
